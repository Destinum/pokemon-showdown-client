(function (exports, $) {
	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		renderSet: function (set, i) {
			...
			var isRebalanced = this.curTeam.format.includes('rebalanced');
		...
		chartSetCustom: function (val) {
			...
			if (val === 'cathy') {
				...
				if (baseFormat.substr(0, 4) === 'bdsp') baseFormat = baseFormat.substr(4);		//Custom and/or fakemon add here maybe? Haven't done anything atm though.
