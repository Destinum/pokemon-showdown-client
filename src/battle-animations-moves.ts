...
BattleMoveAnims['witheringgrasp'] = {anim: BattleMoveAnims['leechlife'].anim};
BattleMoveAnims['mercurybomb'] = {anim: BattleMoveAnims['sludgebomb'].anim};
BattleMoveAnims['magicacid'] = {anim: BattleMoveAnims['sludge'].anim};
